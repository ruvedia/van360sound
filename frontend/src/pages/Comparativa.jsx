                                ...
                                {selectedHeadphones[colIndex] ? (
                                    <div className="selected-headphone-card">
                                        ...
                                        <div className="specs-list">
                                            ...
                                            <div className="spec-item">
                                                <span className="spec-label">Conexión</span>
                                                <span className="spec-value">{selectedHeadphones[colIndex].connection_type}</span>
                                            </div>
                                            <div className="spec-item">
                                                <span className="spec-label">Batería</span>
                                                <span className="spec-value">{selectedHeadphones[colIndex].battery_life_hours ? `${selectedHeadphones[colIndex].battery_life_hours}h` : '-'}</span>
                                            </div>
                                            <div className="spec-item">
